...
export default function CreateBodyDialog({ onCreate }: CreateBodyDialogProps) {
  const [formData, setFormData] = useState<CuerpoInhumado>({
    idCadaver: "", // Will be generated by backend, left empty here
    nombre: "",
    apellido: "",
    documentoIdentidad: "",
    ...
    causaMuerte: "",
    fechaNacimiento: "",
    fechaDefuncion: new Date(), // Initialized as Date object
    fechaIngreso: "",
    fechaInhumacion: "",
    fechaExhumacion: "",
    funcionarioReceptor: "",
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData((prev) => ({
      ...prev,
      [name]: name === "fechaDefuncion" ? (value ? new Date(value) : null) : value,
    }));
  };
  ...
  const handleCreate = async () => {
    ...
    try {
      const bodyData: CuerpoInhumado = {
        ...formData,
        fechaDefuncion: formData.fechaDefuncion ? new Date(formData.fechaDefuncion) : new Date(),
      };
      ...
      setFormData({
        ...
        causaMuerte: "",
        fechaNacimiento: "",
        fechaDefuncion: new Date(), // Reset to new Date object
        fechaIngreso: "",
        fechaInhumacion: "",
        fechaExhumacion: "",
        funcionarioReceptor: "",
